...
Message: ${a}` };
        try {
          return await i.sendMail(c), console.log("Email sent successfully"), { statusCode: 200, body: JSON.stringify({ message: "Email sent successfully" }) };
        } catch (e4) {
          return console.error("Error sending email:", e4.message), console.error("Error stack:", e4.stack), { statusCode: 500, body: JSON.stringify({ error: "Error sending email", message: e4.message }) };
        }
      } catch (e4) {
        return console.error("Error parsing event body or missing environment variables:", e4.message), console.error("Error stack:", e4.stack), { statusCode: 400, body: JSON.stringify({ error: "Invalid request body or missing environment variables", message: e4.message }) };
      }
    } };
  }, 818: (e2) => {
    "use strict";
    e2.exports = require_main();
  }, 572: (e2) => {
    "use strict";
